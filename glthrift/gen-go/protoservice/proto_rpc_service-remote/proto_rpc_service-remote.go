...
var _ = protoservice.GoUnusedProtection__
...
func main() {
	...
	client := protoservice.NewProtoRpcServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "dealTwowayMessage":
		...
		value0 := argvalue0
		fmt.Print(client.DealTwowayMessage(context.Background(), value0))
		fmt.Print("\n")
		break
	case "dealOnewayMessage":
		...
		value0 := argvalue0
		fmt.Print(client.DealOnewayMessage(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
